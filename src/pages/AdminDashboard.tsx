...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#F8F9FB] font-sans">
      {/* SIDEBAR: SwiftCart Dark Mode Style */}
      ...
      <main className="flex-1 overflow-y-auto">
        <header className="bg-white/80 backdrop-blur-md border-b border-slate-100 py-6 px-10 flex justify-between items-center sticky top-0 z-10">
           ...
           <div className="flex gap-4">
              <div className="px-4 py-2 bg-slate-50 border border-slate-100 rounded-full text-[10px] font-black uppercase tracking-widest text-slate-400">
